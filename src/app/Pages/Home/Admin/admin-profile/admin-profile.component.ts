...
export class AdminProfileComponent implements OnInit {
  ...
  getadminDetail(){
    debugger
    this.spinner.show();
    this.contentService.UserAdminDetail(this.Id).subscribe(response => {
      this.spinner.hide();
      if (response.isSuccess) {
        ...
        this.bankDetailPatch = this.adminDetailPatch.bankResponses
        this.upiDetailPatch = this.adminDetailPatch.upiResponses
        ...
        if (this.adminDetailPatch.upiResponses) {
          this.adminDetailPatch.upiResponses.forEach((element: any) => {
  ...
  //   debugger
  //   this.spinner.show();
  //   this.contentService.UseradminDetail().subscribe(response => {
  //       if (response.isSuccess) {
  //         this.usersadminDetail = response.data
  //         this.spinner.hide();
  //   }
    // this.spinner.hide();
    // });
